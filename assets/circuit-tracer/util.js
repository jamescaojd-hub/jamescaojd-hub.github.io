window.util = (function () {
  ...
  async function getFile(path, useCache = true, fileType = null, range = null) {
    ...
    // NOTE: hosted-mode patch — keep ./data/ and ./graph_data/ as relative paths
    // so they resolve against the same origin (GitHub Pages). The upstream code
    // re-routes them to CloudFront when running on localhost, which breaks
    // self-hosted custom graphs.
